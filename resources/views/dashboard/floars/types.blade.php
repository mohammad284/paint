...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">{{__('floar types')}}</h6>
        <a type="button"  href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"> {{__('add new type')}}</a>
          ...
          <table id="dataTableExample" class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$floar->translate('de')->name}}</td>
                    <td>{{$floar->created_at}}</td>
                    <td class="action"> 
                    <a  title="{{__('edit')}}" href="#" data-bs-toggle="modal" data-bs-target="#floar-{{$floar->id}}"><i data-feather="edit"></i></i></a>
                        <a  title="{{__('delete')}}" href="/admin/deleteFlo/{{$floar->id}}" onclick="showSwal('mixin')"><i data-feather="trash"></i></i></a>
                    </td>
                </tr>
              @endforeach
            </tbody>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">{{__('add type')}}</h5>
            ...
            <div class="row mb-6">
                <div class="col-md-6">
                    <label for="exampleInputNumber1" class="form-label">{{__('floar/en')}}</label>
                    <input class="form-control mb-4 mb-md-0" name="name_en"  required/>
                </div>
                <div class="col-md-6">
                    <label class="form-label">{{__('floar/gr')}}:</label>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="row mb-6">
                ...
                <div class="col-md-6">
                    <label class="form-label">{{__('floar/gr')}}:</label>
                    <input class="form-control mb-4 mb-md-0" name="name_gr" value="{{$floar->translate('de')->name}}" required/>
                </div>
                <div >
                <br>
              </div>
