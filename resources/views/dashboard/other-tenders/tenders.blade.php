...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
        <div class="card-body">
            <h6 class="card-title">{{__('other tenders')}}</h6>
            <div class="table-responsive">
                <table id="dataTableExample" class="table">
                    <thead>
                    <tr>
                        <th>{{__('user')}}</th>
                        <th>{{__('tender type')}}</th>
                        <th>{{__('sub type')}}</th>
                        <th>{{__('furnished')}}</th>
                    ...
                    <tbody>
                        @foreach($tenders as $tender)
                            <tr>
                                ...
                                <td>{{$tender['business_type']->name}}</td>
                                ...
                                <td class="action"> 
                                    <a  title="{{__('more details')}}" href="/admin/otherTenderDetails/{{$tender->id}}"> <i data-feather="eye"></i></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
