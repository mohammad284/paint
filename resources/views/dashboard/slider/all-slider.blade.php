          ...
          <table id="dataTableExample" class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="action"> 
                      <a  title="{{__('edit')}}" href="#" data-bs-toggle="modal" data-bs-target="#slider-{{$slider->id}}"><i data-feather="edit"></i></i></a>
                      <a  title="{{__('delete')}}" href="/admin/deleteSlider/{{$slider->id}}"  onclick="showSwal('mixin')"><i data-feather="trash"></i></i></a>
                    </td>
                </tr>
              @endforeach
            </tbody>
            ...
            <div class="modal-body">
                <form class="forms-sample"  method="POST" enctype="multipart/form-data" action="/admin/updateSlider/{{$slider->id}}">
                    ...
                    <div class="row mb-12">
                        ...
                        <div class="col-md-12">
                            <label for="exampleInputNumber1" class="form-label">{{__('text/gr')}}</label>
                            <input class="form-control mb-4 mb-md-0" name="text_gr" value="{{$slider->translate('de')->text}}"  required/>
                        </div>
                        <div >
                          <br>
                        </div>
