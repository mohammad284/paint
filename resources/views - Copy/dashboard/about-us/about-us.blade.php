...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h6 style="font-size:20px;" class="card-title">{{__('نبذة عنا')}}</h6>
        <form class="forms-sample" method="POST" enctype="multipart/form-data" action="/admin/updateAboutUs">
          @csrf
          <div class="row mb-6">

            <div class="col-md-6">
                <label for="exampleInputNumber1" class="form-label">{{__('ايميل الدعم')}}</label>
            ...
            <div class="col-md-6">
                <label for="exampleInputNumber1" class="form-label">{{__('الهاتف الارضي')}}</label>
            ...
            <div class="col-md-6">
                ...
                <textarea style="height: 150px;" class="form-control" name="bio_gr" required>{{$about_us->translate('gr')->bio}}</textarea>
            </div>
          </div>
            <div class="row">
                <div class="col-md-6 stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">{{__('الصور')}}</h6>
