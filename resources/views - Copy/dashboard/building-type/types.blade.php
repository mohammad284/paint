          ...
          <table id="dataTableExample" class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$building->translate('gr')->name}}</td>
                    ...
                    <a  title="{{__('edit')}}" href="#" data-bs-toggle="modal" data-bs-target="#building-{{$building->id}}"><i data-feather="edit"></i></i></a>
                        <a  title="{{__('delete')}}" href="/admin/deleteBuil/{{$building->id}}"><i data-feather="trash"></i></i></a>
                    </td>
                </tr>
              @endforeach
            </tbody>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="row mb-6">
                ...
                <div class="col-md-6">
                    <label class="form-label">{{__('building/gr')}}:</label>
                    <input class="form-control mb-4 mb-md-0" name="name_gr" value="{{$building->translate('gr')->name}}" required/>
                </div>
                <div >
                <br>
              </div>
