  ...
  <div class="navbar-content">
    ...
    <ul class="navbar-nav">
      <li class="nav-item dropdown">
        ...
        @if ($lang == 'en')
        <div class="dropdown-menu"  @if($lang == 'en'||$lang == 'gr') style="left: -110px;"@endif aria-labelledby="languageDropdown">
          ...
          <a href="/change-language/gr" class="dropdown-item py-2"><i class="flag-icon flag-icon-de" title="de" id="de"></i> <span class="ms-1"> German </span></a>
        </div>
        @else
        <div class="dropdown-menu"  @if($lang == 'en'||$lang == 'gr') style="left: -110px;"@endif aria-labelledby="languageDropdown">
          <a href="/change-language/en" class="dropdown-item py-2"><i class="flag-icon flag-icon-us" title="us" id="us"></i> <span class="ms-1"> English </span></a>
