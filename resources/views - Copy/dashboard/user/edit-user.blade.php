            ...
            <div class="row mb-6">
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control mb-4 mb-md-0" name="bank_name" value="{{$user->bank_name}}"  required/>
                </div>
                <div class="col-md-6">
                    <label for="exampleInputNumber1" class="form-label">{{__('card_name')}}</label>
                    <input class="form-control mb-4 mb-md-0" name="card_name"value="{{$user->card_name}}" required/>
                </div>
                <div >
                  <br>
                </div>
                <div class="col-md-6">
                    ...
                    <input class="form-control mb-4 mb-md-0"  name="card_num" value="{{$user->card_num}}" required/>
                </div>
                <div class="col-md-6">
                    <label for="exampleInputNumber1" class="form-label">{{__('card_time')}}</label>
                    <input class="form-control mb-4 mb-md-0" type="date" name="card_time" value="{{$user->card_time}}" required/>
                </div>
                <div >
                  <br>
                </div>
                <div class="col-md-6">
                    ...
                    <input class="form-control mb-4 mb-md-0" name="card_type" value="{{$user->card_type}}"  required/>
                </div>
                <div class="col-md-6">
                  <div class="mb-3">
